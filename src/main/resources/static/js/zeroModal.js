...
(function(obj) {
    ...
    function _buildModal(opt) {
        ...
        //// 构建容器
        var _container = $('<div zero-unique-container="' + opt.unique + '" class="zeromodal-container" style="z-index:' + _tmp_last_zindex + ';width:' + _width + 'px;top:' + (opt.transition ? _top - 50 : _top) + 'px"></div>');
    ...
    function _resize(opt, width, height) {
        ...
        var _left = (_wwidth - _width) / 2;
        var _top = $(window).scrollTop() + Math.ceil(($(window).height() - _height) / 3);
        $('[zero-unique-container="' + opt.unique + '"]').css('width', _width + 'px').css('top', _top + 'px');
    }
    ...
    function _resizePostion(opt) {
        ...
        var _left = (_wwidth - _width) / 2;
        var _top = $(window).scrollTop() + Math.ceil(($(window).height() - _height) / 3);
        $('[zero-unique-container="' + opt.unique + '"]').css('top', _top + 'px');
    }
